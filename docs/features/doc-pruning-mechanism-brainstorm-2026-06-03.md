...
When a doc trips, run a manual session (operator + Claude Code back-and-forth, the shape of the CLAUDE.md compaction in [docs/sprints/pruning-cases/001-claude-md-compaction.md](docs/sprints/pruning-cases/001-claude-md-compaction.md)). Two standing rules on every exercise:
