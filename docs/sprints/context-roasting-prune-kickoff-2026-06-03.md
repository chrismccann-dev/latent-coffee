...
This is the **first deliberate dogfood** of the doc-pruning protocol scoped at [docs/features/doc-pruning-mechanism-brainstorm-2026-06-03.md](docs/features/doc-pruning-mechanism-brainstorm-2026-06-03.md). Its explicit job is to test the protocol live and produce the case-002 handoff doc.

## Why this doc, why now

`CONTEXT-roasting.md` is **115.8 KB / 120 KB (96%)** — the live fire in [docs/architecture/doc-tripwires.md](docs/architecture/doc-tripwires.md). It is section-read at every claude.ai roasting session, the largest CONTEXT zone file, and the one approaching its tripwire.
...
- Update the [doc-tripwires.md](docs/architecture/doc-tripwires.md) Current-size column + Live queue.
