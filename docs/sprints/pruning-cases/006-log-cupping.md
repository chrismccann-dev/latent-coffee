...
- **Trigger:** 🔴 over the 40 KB prompt cap; #1 in the [doc-tripwires.md](../../architecture/doc-tripwires.md) Live queue. First prompt-shape (procedure) case taken through the protocol.
