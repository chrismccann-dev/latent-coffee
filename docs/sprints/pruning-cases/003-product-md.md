...
- **Trigger:** root-doc 120 KB tripwire ([doc-tripwires.md](../../architecture/doc-tripwires.md) live queue #2). The Roadmap was the growth driver (330 of 758 lines).
...
Operator walkthrough = the section-by-section audio in the kickoff thread + the `product_md_refactor_bundle` prototype (PRODUCT.refactored.md / PRODUCT_ROADMAP.refactored.md / PRODUCT_ISSUES.refactored.md / PRODUCT_REFACTOR_HANDOFF.md). Claude Code synthesis + four AskUserQuestion forks (all recommended options chosen) → one-PR execution. Per the kickoff ([product-md-prune-kickoff-2026-06-03.md](../product-md-prune-kickoff-2026-06-03.md)).
