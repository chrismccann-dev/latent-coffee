...
| 4 | Human-write surface deprecation | ~3h actual (vs ~1 day kickoff sizing) | SHIPPED — [PR #270](https://github.com/chrismccann-dev/latent-coffee/pull/270) / main commit via roadmap-currency follow-up | Inline § below |
