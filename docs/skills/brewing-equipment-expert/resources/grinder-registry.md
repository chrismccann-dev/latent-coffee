...
Validation mirror for the grinder canonical registry. **Code, not docs** — authored content lives in [../cluster/grinder-eg1.md](docs/skills/brewing-equipment-expert/cluster/grinder-eg1.md); this pointer surfaces the .ts file as a knowledge-cluster resource without migrating it out of `lib/`.
...
- **Editing rule:** 2-step deliberate edit per CLAUDE.md § Canonical registries — update [../cluster/grinder-eg1.md](docs/skills/brewing-equipment-expert/cluster/grinder-eg1.md) AND this .ts file in the same commit. Adding a new grinder = registry edit + new `validSettings` enumeration.
