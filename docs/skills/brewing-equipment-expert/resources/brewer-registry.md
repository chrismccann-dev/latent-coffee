...
- **Shape:** 47 canonical brewers (13 owned by Chris) + 26 aliases. Material axis (Glass / Porcelain / Ceramic) stripped on canonicalize per the authored decision in [../cluster/brewers.md](docs/skills/brewing-equipment-expert/cluster/brewers.md).
