...
Validation mirror for the SWORKS Bottomless Dripper valve-dial canonical registry. **Code, not docs** — authored content lives in [../cluster/sworks.md](docs/skills/brewing-equipment-expert/cluster/sworks.md); this pointer surfaces the .ts file as a knowledge-cluster resource without migrating it out of `lib/`.
...
- **Editing rule:** 2-step deliberate edit per CLAUDE.md § Canonical registries — update [../cluster/sworks.md](docs/skills/brewing-equipment-expert/cluster/sworks.md) AND this .ts file in the same commit. Adding a second valve-modulated brewer = deliberate registry extension.
