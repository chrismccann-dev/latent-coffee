...
- **Axis 2 (Extraction Modifiers)** = optional stackable techniques layered on top of the strategy. 4 canonical modifier types: `output_selection` (with form sub-fields including dilution), `inverted_temperature_staging`, `aroma_capture`, `role_based_pulse`. Most coffees warrant none. See [brewing-assistant/cluster/operational-guide.md § Axis 2](docs/skills/brewing-assistant/cluster/operational-guide.md) for the per-modifier framing.
