...
| Sub-skill | Domain | Wave | Status | In | Out | Patterns |
|---|---|---|---|---|---|---|
| [Cross-Coffee Insight Layer (CCIL)](../ccil/SKILL.md) | cross-domain | 4 | placeholder | Historian patterns + WBC archivist patterns + per-entity terminal synthesis caches | cross-domain pattern docs + planner recommendations | A, D, F (F primary) |
