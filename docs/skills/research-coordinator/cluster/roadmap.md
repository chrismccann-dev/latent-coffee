...
**Track structure (scoped 2026-07-30, operator sign-off):** track = coffee. **Track 1 CLOSED 2026-08-03** — El Oasis full ladder: **1:10 beat the optimized 1:16 control** (1.50% TDS, 1.70×, caramel/honey/wine-grape transformation) [unblinded-serial; anecdote-unreproduced — repeat vial was a 5 g bag excess]; boundary at 1:8 (Gesha collapse signature), 1:9 degradation zone; grind coefficient amended −0.1 → −0.07/pt (taste optimum drifts coarser than iso-extraction; EY held flat 14–15.4% all ladder); H3 warm-to-cool payoff counter-evidenced at short ratio (winner compelling from hot). Archive + brief: [concentrated-pourover-t1-full-ladder.md](docs/research-projects/concentrated-pourover-t1-full-ladder.md) (folded PR #609). **Track 2 SCOPED 2026-08-03** — Moonwake Motta (anaerobic washed Gesha, the sturdy testbed), abbreviated ladder rung-0 / 1:10 / 1:9 / protected later-day repeat, 4 vials, −0.07/pt rule as the H2 retest, plain PA tap whole track: [concentrated-pourover-t2-motta-abbreviated-ladder.md](docs/research-projects/concentrated-pourover-t2-motta-abbreviated-ladder.md) + spawn prompt alongside. Track 2 carries the project's reproduction burden (P8-AI-3) — its repeat verdict is the low-pressure-branch unlock assessment. Remaining shortlist: Ngoma Station (4; Kalita control) · Loud Giants / Chombi (4 each; SWORKS controls — need comparability decision first). Low-pressure AeroPress branch = own track, unlocks after the gravity optimum repeats across 2+ coffees (operator owns no AeroPress; purchase = the unlock's first action). No push_brew during the project — trial records live in the protocol docs; durable representation decided post-project with grilling item 56.
