...
- **Future RP6 tracks (2026 WBC-seeded, [handoff](docs/research-projects/wbc-2026-water-handoff.md)):** stage-split mineral profiling (Mg-early/Ca-late - native xBloom fit); potassium-as-finish (**KCl IN HAND**); silica-as-texture (**Eidon silica IN HAND**); NaCl (Morton pickling) in hand for seasoning. Anchor: the **straight-MgCl₂ peak** (the Sitting-1 two-chloride pointer is retired - it rested on CaCl₂'s post-brew artifact, which inverted to lactic pre-brew) → test "+ a touch of sulfate + silica on the MgCl₂ base" ≈ Delgado's formula logic.
