...
**Track structure (scoped 2026-07-30, operator sign-off):** track = coffee. **Track 1 CLOSED 2026-08-03** — El Oasis full ladder: **1:10 beat the optimized 1:16 control** (1.50% TDS, 1.70×, caramel/honey/wine-grape transformation) [unblinded-serial; anecdote-unreproduced — repeat vial was a 5 g bag excess]; boundary at 1:8 (Gesha collapse signature), 1:9 degradation zone; grind coefficient amended −0.1 → −0.07/pt (taste optimum drifts coarser than iso-extraction; EY held flat 14–15.4% all ladder); H3 warm-to-cool payoff counter-evidenced at short ratio (winner compelling from hot). Archive + brief: [concentrated-pourover-t1-full-ladder.md](docs/research-projects/concentrated-pourover-t1-full-ladder.md) (folded PR #609). **Track 2 CLOSED 2026-08-10** — Moonwake Motta (anaerobic washed Gesha, the sturdy testbed), abbreviated ladder on the −0.07/pt rule: **reproduction gate MET (P8-AI-3 resolved)** — the 1:10 winner repeated later-day at 1.78% vs 1.77% TDS, operator-explicit "more than reproduced"; 1:10 optimum + 1:9 boundary replicated across both coffees (boundary leans ratio-intrinsic; failure signature is coffee-structural — Motta's is a new split-balance incoherence); stage compression proved coffee-dependent (Motta kept its cool peak at 1.46×); no ferment amplification; −0.07/pt taste-adequate but not iso-extraction (RP8-N5). Track 2's win was best-concentrated-cup, not a clean control-beat — the strict-reading caveat on the unlock is an operator call (escalated). Archive + brief: [concentrated-pourover-t2-motta-abbreviated-ladder.md](docs/research-projects/concentrated-pourover-t2-motta-abbreviated-ladder.md). **Track 3 SCOPED 2026-08-10** — Picolot Loud Giants (Pacamara natural, SWORKS Full Expression control — the Kalita-comparability disqualifier inverts on a valve track): SWORKS valve at 1:10, CONSTANT control grind 6.1 + 95°C, contact via valve (control re-brew / V-A restriction-led / adaptive V-B / protected later-day repeat, 4 vials): [concentrated-pourover-t3-loud-giants-valve.md](docs/research-projects/concentrated-pourover-t3-loud-giants-valve.md) + spawn prompt alongside. P8-AI-4 reframed generic (Motta sold out): constant-grind design tests whether the tannin tax is grind-driven. P8-AI-2 RETIRED (operator call 2026-08-10; revivable opportunistically). **Low-pressure branch UNLOCKED** (gate met per pre-stated condition; AeroPress acquired 2026-08-10) — sequenced as T4+ behind valve work; T4 decision (Chombi gravity track vs opening the AeroPress branch) consumes T3's style-mechanism statement. Remaining Kalita-control shortlist: Ngoma Station (4 vials); Chombi (4, SWORKS Suppression control) = natural T4 gravity candidate. RP8-N3 office-lane capture trims: second fire clean — graduation queued for the RP8 process retro (methodology-discipline gate), carried forward in T3 meanwhile. No push_brew during the project — trial records live in the protocol docs; durable representation decided post-project with grilling item 56.
