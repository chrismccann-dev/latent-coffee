...
**Kickoff brief:** [docs/features/output-fractionalization-research-kickoff-2026-08-27.md](docs/features/output-fractionalization-research-kickoff-2026-08-27.md) (item-56 soft gate cleared — drained 2026-08-31). **Scoped 2026-09-01:** SWORKS valve-hold is the fractionation instrument (bloom / pour 1 / pour 2 at pour boundaries, recipe untouched); track = coffee, exploratory; operator thesis logged as H1 (concentrated pour-over ≈ front-retention + tail cutoff); recombination-vs-bypass carried as central question; no blind (character reads, RP8-N15 acknowledged); AeroPress/WAC fraction read deferred to project close. **Track 1:** Project One Blue Iris (5 vials, archived SWORKS control `f404e3b0`), 3 sittings + reserve — protocol [output-fractionalization-t1-blue-iris-valve-fractions.md](docs/research-projects/output-fractionalization-t1-blue-iris-valve-fractions.md) + [spawn prompt](docs/research-projects/output-fractionalization-t1-blue-iris-valve-fractions-spawn-prompt.md). **Track 1 CLOSED 2026-09-14** (archive: docs/research-projects/output-fractionalization-t1-blue-iris-valve-fractions.md). Verdicts: H-artifact PASS (valve fractionation is artifact-clean - method validated for future tracks) · H2 SUPPORTED (monotonic fraction gradient 1.88/1.48/0.70; recombination TDS predictable by weight arithmetic to ~0.07) · H1 SUPPORTED (fresh 1:10 cup landed at B+P1's exact TDS, 1.41 vs 1.42, and character family - short ratio ≈ keeping the front) · H3 directional-SUPPORTED (at matched TDS, tail-removal reads brighter/crisper vs the 1:10's deeper/rounder - removal and concentration are neighboring but distinct levers). Blue Iris taxonomy entry: REWARDS output selection via front-weighted re-proportion (trace tail ~5-8% of cup mass), not hard front-cut. Winning cup replicated single-brew; signature-method candidate (doc-only, no push_brew - RP9 default). Lessons RP9-N1..N5 + audit items P9-AI-1..3 in the archive. **Track 2 SCOPED 2026-09-15:** Tabaco Pata Juanito Navarro Washed SL9 (the generalization test — clean washed contrast to T1's yeast-anaerobic honey; taxonomy fork: does front-weighted re-proportion generalize, or does a pleasant tail make the full cup win?). Control dial-in run outside RP9 (brew `10c46241`, converged cup 1, locked deliberately as fractionation substrate); 5 of 11 vials allocated; T1 refinements RP9-N1..N4 baked in as defaults — protocol [output-fractionalization-t2-tabaco-pata-sl9-valve-fractions.md](docs/research-projects/output-fractionalization-t2-tabaco-pata-sl9-valve-fractions.md) + [spawn prompt](docs/research-projects/output-fractionalization-t2-tabaco-pata-sl9-valve-fractions-spawn-prompt.md). **Track 2 CLOSED 2026-09-23** (archive: docs/research-projects/output-fractionalization-t2-tabaco-pata-sl9-valve-fractions.md). Verdict: Tabaco Pata SL9 REWARDS output selection via BLOOM removal - the INVERSE of Blue Iris's tail-cut. Winning build: discard the bloom fraction (~10% of cup mass), keep P1+P2 in full; replicated blind ×2 incl. lived brews, with a matched-TDS read (1.02 vs 0.98) making the win character-shaped, not strength-shaped. **The project taxonomy is now 2-dimensional: rewards-selection? × which-fraction-is-the-tax** (Blue Iris: tail · Tabaco Pata: bloom). T1's winning proportion finished LAST here - no default winning shape; per-coffee straight-fraction probe picks the design (RP9-N6). 1:10 valve cup confirmed as a front-preview instrument on coffee #2 (H1 method property). 6 vials spent (+1 operator-authorized). Lessons RP9-N6..N9 + P9-AI-4 (control-row transcription drift, corrected at fold) in the archive. **Track 3 SCOPED 2026-09-24 (operator-called, expected final track — the WORKFLOW track):** La Dinastia Wilder Lazo Lemongrass Yellow Honey Gesha (deliberate middle case, ambiguous tax candidates). Validates the operator's synthesized 3-step curation workflow (probe fractions for the tax → cut/down-weight → recombine keepers toward an intent: concentrate-and-emphasize or lengthen-and-smooth, "like a mixologist") run cold as the protocol; tests predictiveness (sealed ex-ante tax calls, operator + Assistant) and the LENGTHENING intent (keepers + water — bypass inside a curation). Control dial-in outside RP9 (brew `23b48be7`, converged cup 1, recorded as-lived; P9-AI-5 seeded: row's producer field wrongly "Wilton Benitez" — fold-session patch_brew). 5 of ~14 vials — protocol [output-fractionalization-t3-la-dinastia-gesha-curation-workflow.md](docs/research-projects/output-fractionalization-t3-la-dinastia-gesha-curation-workflow.md) + [spawn prompt](docs/research-projects/output-fractionalization-t3-la-dinastia-gesha-curation-workflow-spawn-prompt.md). Project close + end-document + retro expected after this track; the coffee-#4-ready workflow writeup is the end-document's centerpiece.
...
**→ Ran as Research Project #6 (2026-06-20 → 2026-07-19), now CLOSED - see § Closed.** (Was the highest-payoff queue pick; operator pulled it forward at RP5 close.) The combination-space follow-up is parked in § Extensions of completed. The remaining § Next entries keep their numbers.
...
### Water combination space (RP6 extension - PARKED, operator-called break)

RP6's retro insight (operator, 2026-07-19): per-mineral → flavor-axis mapping is NOT clean - each salt acts on multiple axes and the interactions dominate, so the project derived a verified BASE water but did not map the combination space (multi-salt recipes beyond the two blends tested). Candidates when appetite returns: the three-parter (peak + light gypsum + 2 ppm NaCl, P6T4-AI-3) · 5:1-vs-4:1 ratio head-to-head (P6T4-AI-4) · stage-split mineral profiling (the WBC-seeded future track). **Trigger:** operator renewed interest - explicitly not queued; "sick of water research for now."

*Previous entries absorbed (2026-05-27 talk-through):*
...
### Concentrated pour-over / high-strength filter (Research Project #8, 2026-07-29 → 2026-08-27) — OFFICE LANE, first occupant

Five tracks, five coffees, four mechanisms, ~22 scored cups; the WBC routine-differentiation bet VALIDATED — the style is real, reproduced, and mapped. **Retro completed 2026-08-27**; graduations: office-lane charter ([office-lane.md](docs/skills/research-coordinator/cluster/office-lane.md), new) · split-cup blind pair + per-vial weigh + one-bench-free-parameter → [calibration-arc.md](docs/skills/research-coordinator/cluster/calibration-arc.md) primitives 9–11 + budget-conditional control guidance · provisional-lesson-numbering note → handoff-brief template · transcription-verify note → spawn template. **End-document (mechanism map + full ledgers): [concentrated-pourover-project-end-document.md](docs/research-projects/concentrated-pourover-project-end-document.md).**

| Track | Coffee / mechanism | Closed | Archive |
|---|---|---|---|
| 1 | El Oasis — full gravity ratio ladder | 2026-08-03 | [t1](docs/research-projects/concentrated-pourover-t1-full-ladder.md) |
| 2 | Motta — abbreviated ladder (reproduction gate MET) | 2026-08-10 | [t2](docs/research-projects/concentrated-pourover-t2-motta-abbreviated-ladder.md) |
| 3 | Loud Giants — SWORKS valve, constant grind | 2026-08-18 | [t3](docs/research-projects/concentrated-pourover-t3-loud-giants-valve.md) |
| 4 | Chombi — post-brew drops, split-cup blind tournament | 2026-08-24 | [t4](docs/research-projects/concentrated-pourover-t4-chombi-postbrew-drops.md) |
| 5 | Project One Peach — AeroPress low-pressure | 2026-08-27 | [t5](docs/research-projects/concentrated-pourover-t5-aeropress-low-pressure.md) |

**Headline:** 1:10-strength is the style optimum across mechanisms; the BOUNDARY is mechanism-dependent (1:9 percolation wall vs 1:7.5 coherent under press); tannin tax is grind-driven; best forms = valve-percolation 1:10 + immersion-press at 1:10-strength; identity amends to "no dilution past optimum" (bypass-to-optimum won blind against the operator's own prior); locked office TONIK+JAMM dose survives concentration. **Strategic close (retro answer 22, operator):** the style IS the signature-method candidate — lay tasters read it as its own category ("not quite pour over, not quite espresso... more on the pour over side" of soup); two competition routes now visible: WBC via SWORKS-percolation concentrated form, or the **AeroPress Championship as a lower-stakes entry rung first** (2026 season passed; 2027 target possible). The imagined full-stack routine — complex layered coffee, self-roasted with layered roast levels, concentrated format, bypass-to-optimum, water pushed further than pour-over tolerates — "is as close to a winning recipe routine as I can think of."

### Water chemistry & mineral concentrates (Research Project #6, 2026-06-20 → 2026-07-19)

Third project on the Coordinator/Assistant architecture and the largest to date: 4 experimental tracks + a codification arc + 2 follow-on screens, 6 Assistant sessions, ~60 brewed cups across three coffees (Pink Bourbon / Helm Mystic / Gesha Natural). **Retro completed 2026-07-19 - the three-role model (Coordinator thread / fresh Assistant sessions / compile folds) is RATIFIED as a staple for research-shaped projects** (operator: deep per-track work without filling the Coordinator's context "really proved the model"). Closed 2026-07-19.

| Track | Methodology | Closed | End-document |
|---|---|---|---|
| 1 - Concentrate screen | 3-lane post-brew semi-blind product screen | 2026-06-21 | [water-concentrate-postbrew-screen.md](docs/research-projects/water-concentrate-postbrew-screen.md) |
| 2 - Single-mineral isolation | hybrid post-brew→pre-brew, 5 HTs resolved | 2026-07-03 | [water-single-mineral-isolation.md](docs/research-projects/water-single-mineral-isolation.md) |
| Codification A + B | water.md substrate + /brew Phase B wiring | 2026-07-04 | [phase-a](docs/research-projects/water-codification-phase-a-plan.md) / [phase-b plans](docs/research-projects/water-codification-phase-b-plan.md) |
| Modifier screen | KCl/silica/NaCl on the PB peak + distilled | 2026-07-12 | [water-modifier-minerals.md](docs/research-projects/water-modifier-minerals.md) |
| Phase 2b - 2nd-coffee verification | Gesha, 19 brews, 2 sittings, HV1-HV4 | 2026-07-17 | [water-2nd-coffee-verification.md](docs/research-projects/water-2nd-coffee-verification.md) |
| Final screen | modifiers + blend variants + blind ordering | 2026-07-19 | [water-final-screen.md](docs/research-projects/water-final-screen.md) |

**Headline:** the anion-sets-the-phase-of-cup / cation-gates-it mechanism (chloride = front, sulfate = back, complements) + the **2-coffee-verified straight-MgCl2 @ GH 44 / KH 0 peak**. Durable substrate: [water.md](docs/skills/brewing-equipment-expert/cluster/water.md) (knowledge; § 6 recipe library wired into `/brew`) + [water-inventory.md](docs/skills/brewing-equipment-expert/cluster/water-inventory.md) (physical stock + § 3a QC workflow). Retro graduations (operator-ratified): blind-for-ordering-claims · single-read-is-anecdote/reproduce-before-recording · EC-arithmetic-adjudicates-instrument-disputes → [calibration-arc.md](docs/skills/research-coordinator/cluster/calibration-arc.md). WBC field cross-checked: anion-axis structure corroborated; the field's role-labels (sulfate=florality, silica=texture, CaCl2=body) all failed to reproduce on this platform. Post-close errands (non-gating): KCl remnant arm on arrival · scale bench test (P6T4-AI-1, before next water sitting) · optional three-parter micro-flight (P6T4-AI-3, ~36 g Gesha remains).
