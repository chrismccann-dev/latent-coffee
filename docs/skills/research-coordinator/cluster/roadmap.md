...
- **Phase 2b (2nd-coffee replication)** - the VALUES verification (structure no longer gated on it). **Coffee IN HAND (2026-07-04): Hydrangea Gesha Natural DRD, El Burro Lot 15** (rested; the body-forward contrast that tests the coffee-dependence prediction - the desired phase may flip toward sulfate). Awaiting operator dial-in, then a fresh Assistant track (focused pre-brew anion→phase replication, ~15-20 brews / ~300g).
