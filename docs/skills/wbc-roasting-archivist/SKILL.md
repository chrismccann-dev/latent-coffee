...
- **Cross-system propagation:** ARBITER.md routing updated to direct new `propose_doc_changes` proposals at WBC roasting / sourcing content into the cluster; CONTEXT.md / ROASTING.md / start-lot.md path refs updated.
