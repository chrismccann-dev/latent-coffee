...
The WBC-corpus-derived 3-value classification of green-bean lots for **buying decisions** — a "soft guiding post" (Chris-locked 2026-05-16) for sourcing, NOT a canonical-validation surface. See [CONTEXT-shared.md § Sourcing tier](../../../../../CONTEXT-shared.md) for the canonical glossary entry.
...
|---|---|---|
| **T1** | High-signal "buy when found" | Direct-from-farm Geisha, washed Sudan Rume from referenced producers, named auction lots |
| **T2** | Conditional "buy when paired with a portfolio gap" | Process-experimental lots from T1-producers, lane-filling Naturals, learning hybrids |
| **T3** | Awareness-only "track but don't buy" | Speculative origins, lots without producer/process traceability, gimmick-tier auction lots |
...
- [CONTEXT-shared.md § Sourcing tier](../../../../../CONTEXT-shared.md) — canonical glossary
