...
- La Palma y El Tucan Sidra Natural B-068 (Colombia, Sidra) - roast-queue #6; first Sidra, fills the named variety gap (yielded the front to the arrived apex lots).
- Finca Deborah Geisha Natural 'Interstellar' (Panama, Jamison Savage) - in its roast arc.
- Janson Pacamara Natural Hacienda 491 (Panama) - #7.
- Caminos del Inka Anaerobic Washed Geisha (Peru) - soon band; anaerobic-washed = cleaner than AN.
- **5 Forward Coffee Panama lots (purchased 2026-06-18, single 1kg range-finders; customs-returned 2026-07-25, reshipped, ARRIVED 2026-09-05 - Los Lajones #3 / Chiroso #4 / El Burro #5 in the front, Nirvana + Elipse soon band):** HiU Los Lajones Geisha Natural Bambu 8B (the named "more like the HiU Los Lajones" benchmark, Forward 93, aroma scored 10/10); Lamastus El Burro Geisha Natural #16 (apex-roster master producer, $160 value workhorse); Black Moon Chiroso Natural #75 (Hunter Tedman / Black Moon Farm - fills the named Chiroso gap); Iris Estate Geisha 'Nirvana' (nitrogen-macerated, red-wine cool turn); Finca Deborah Geisha Hybrid 'Elipse' (natural nitrogen + washed finish, 2024 WBC 1st place). HiU Los Lajones producer is net-new, queued for taxonomy review.

- **3 Kumquat Coffee lots (purchased 2026-07-24, ARRIVED ~2026-09-05 - Maya #1 / Arturo Paz #2 in the front, Ara Amaru soon band; first buy through the Kumquat competition-grade-importer channel):** Lost Origin Maya Tri-Up Yeast Natural Geisha (2x500g = 2 planned V-sets - the deliberate depth exception; LOY-011 yeast + 8-day sealed ferment + 32-day cold-room dry, the WBC-2025-winning lot family, Martin Wölfl); Arturo Paz Dark Room Natural Geisha (Honduras Santa Bárbara, 2x500g - the named non-Panama portability test); Totumas 2608 Ara Amaru Cold Fermentation Natural Geisha (500g, Mount Totumas / Karin Dietrich - comparison arm to the Maya: cold-ferment vs yeast on engineered natural Panama Gesha). Peer-roasted reference bags of the Maya (roasted 7/8) + Arturo Paz (roasted 7/24) bought same day - cup before V1 design. Fran Zeimetz + Arturo Paz producers are net-new, queued for taxonomy review; Mount Totumas is a § 1 signal farm not yet in the producer registry (promotion candidate).
