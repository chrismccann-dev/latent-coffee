# Honey — per-process roasting patterns

*Coffee Research · Latent · Roasting Historian cluster · by-process*

Migrated from ROASTING.md § Honey Process - Roast Direction Fork in Wave 4 PR 4b (2026-05-21). Wave 3 PR 1 Chris-locked this section to ROASTING.md pending Wave 4 cleanup; this is the resolution destination.

**Corpus (active + closed lots):** N=0 closed, N=1 queued — Cruz Loma TM Honey one-shot (Taza Dorada 2024 #15) queued behind Rancho Tio Emilio Typica Mejorado Washed one-shot. This doc is a starting framework, not a confirmed pattern set. **Stub-status until first lot cups.**

## Starting framework (placeholder, single-lot anchor pending)
...
- Single-batch (one-shot lot, ~100-120g, no iteration possible). The roast-direction choice IS the experiment. Document the choice and reasoning before the roast — per [`one-shot.md`](docs/prompts/one-shot.md), the carry-forward language must be prefixed "Low confidence — N=1."

Cup outcome from the first lot will replace this section's hypothesis prose with lot-specific knowledge.

## Cross-references

- [washed.md](docs/skills/roasting-historian/cluster/patterns/by-process/washed.md) — sibling per-process; the "roast toward washed" branch of the fork anchors here
- [natural.md](docs/skills/roasting-historian/cluster/patterns/by-process/natural.md) — sibling per-process; the "roast toward natural" branch anchors here
- [peer-learning-roasting-archivist § Dongzhe — Delta 3 Honey Process Is a Fork](docs/skills/peer-learning-roasting-archivist/cluster/per-peer/dongzhe.md#delta-3--honey-process-is-a-fork-informational--placeholder-framework) — source of the fork framing
- [learnings/ecu-td24-ranchotio-tm-washed.md](docs/skills/roasting-historian/cluster/learnings/ecu-td24-ranchotio-tm-washed.md) — Typica Mejorado anchor lessons (same variety as Cruz Loma TM Honey)
