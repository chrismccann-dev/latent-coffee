# Gesha — per-cultivar brewing patterns
...
- **Washed Gesha** - peaks hot-to-warm. Expression fades gracefully; doesn't dramatically improve cool. (Distinct from the cool-peak naturals below.)
- **Standard raised-bed Panama Gesha Natural** (Finca Sophia Grand Reserve, Coffee with Dongze) - peaks 45-50°C. Rose volatile sits on the cooling arc, not on the attack - emerges around 50°C and deepens below. Hot signature is honey/bergamot/light tea forward; cool signature is honeyed-tea-with-rose. Diagnostic: if rose is absent at 45°C on a properly extracted Panama Gesha Natural, the brew likely under-extracted; if it dominates the attack, over-extracted.
