# Thermal Shock Washed — per-coffee-family brewing patterns
...
**Recipe gradient (flavor-register-driven, not just variety-driven):**

- Rose-forward Geshas (Letty) → 6.3 / 95°C
- Aromatic-floral without rose (Luna: egg waffle / blueberry / oolong) → 6.3 / 94°C
- Lighter floral (Lychee Castillo) → 6.4 / 94°C

**Start recipe:** 6.4 / 94°C. Push grind to 6.3 (hold temp at 94°C) only if thin. Push temperature to 95°C only for rose-forward targets — overshooting on non-rose lots produces over-steeped tea phenolics.
