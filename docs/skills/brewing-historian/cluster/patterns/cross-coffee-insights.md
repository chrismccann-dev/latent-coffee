...
**74-series Ethiopian-landrace confirmed (2026-07-02).** Glitch Coffee Ethiopia Sidama Tamiru Alo Berry "Under Screen" Natural 74165 (Bensa, Sidama; Tamiru Tadesse / Alo Coffee; WB Agtron 77.4 light; brew_id 63ef5778-0634-43c6-a857-6b1bb5423811) adds a second Ethiopian-landrace confirmation of the phase-separation behavior (after SL-28). Brew 1 Clarity-First on the April Glass produced the diagnostic separation - under-expressed attack + thin mid-palate AND an over-extracted bitter back simultaneously, holding as layers on cooling. As on the Snite SL28, the passive April integration vehicle alone did NOT resolve it - the full Intensity-Clarity Split structure on the valve-equipped April Switch was required, and this lot then needed a further Temperature-Staged split (95C P1 / 88C P2) to hold the arc against an off-peak collapse to burnt dark chocolate (full recipe -> by-strategy/hybrid.md, 4th Temperature-Staged data point). Reinforces the generalized rule: for a genuinely separating aromatic-landrace lot, 'switch vehicle before changing grind' extends to 'switch to an immersion-staged structure' when the passive vehicle is not enough. Of the original three Ethiopian-landrace candidates (74110/74112, SL-28, Wush Wush), SL-28 and now the 74-series (via 74165) are confirmed; 74110/74112 specifically and Wush Wush remain individually untested.
...
**Data point - Hydrangea Washed Sidra (Guadalupe Hill Auction Lot / CGLE Las Margaritas), office, 2026-07 (brew f466bfe1).** Extends this pattern three ways. (1) **Not only roast-forward lots:** a light-roast *washed* Sidra on Palo Alto office tap still developed a flat brown-tea body floor once extraction was dialed - office tap can over-fill body even on a clarity lot, not just on developed-roast coffees. (2) **Diagnostic split between the two 'brown tea' reads:** a generic nutty / brown-tea note that is *worst hot and recedes as it cools* is under-extraction (fix with temp + grind); a flat brown-tea *body* that *persists after extraction is dialed* is the water-mineral interaction (do not chase with grind). (3) **Office-side fix (new - the rule above previously only said 'expect heavier body'):** when home built-water isn't available, a **post-brew in-cup mineral correction** lifted the floor - 1 drop APAX Tonik #1 + 1 drop APAX Jamm (~2 ppm/L each) into the final cup restored front clarity + honeyed-tea sweetness and let the coffee's lemon/lime + coriander-seed bag note come forward. This is post-brew dosing (a bounded proxy per [water.md § 5](docs/skills/brewing-equipment-expert/cluster/water.md)), but at the office it is the only water lever available and here it worked as a reveal, not an inject. Standing office move for a tap-flattened cup when built water isn't on hand.

- **Apax Jamm post-brew on a roast-forward office lot (NO°5 Classic Crema, brew 91b546bb, 2026-07-22):** 5 drops Jamm into the finished cup (PA office tap base) read as caramel roundness + filled-out body on a medium-roast Tanzania washed - the Jamm addition worked WITH the roast-forward profile rather than thickening the roast register. Adds to the Apax-under-research thread: on roast-forward office lots, post-brew Jamm is a body/sweetness recovery lever that does not require touching the brew itself.

- **Laurina light natural adds a third 'brown tea'-adjacent read - roast-derived burnt (Picolot #14 Barbie Beans, brew 63aad474, office, 2026-07-28).** Extends the diagnostic split beyond the two reads above: a **burnt/roasty note on aroma + attack that fades as the cup cools** is **roast-derived** (here amplified by a hard-to-roast, low-density Laurina) - lever is lower brew temp (93->90C), not grind. After the temp drop cleared it, the familiar office-tap body-floor surfaced on this *light natural* (confirming read (2) - the water-mineral body-floor - extends past the washed Sidra onto light naturals too); **coarsening 6.6->6.8 lifted fruit above the body**. 2 drops APAX Jamm post-brew emphasized sweetness as the office in-cup lever.
...
- **Yellow Bourbon (Bourbon family, classic lineage; clean anaerobic washed) - n=1, 2026-07-10.** Helm Colombia Los Nogales Mystic (Pitalito, Huila, 1850m, hermetic-tank anaerobic + mosto culture, washed; WB Agtron 87.1 very light; brew ac916f61-322a-4ebb-aca8-179b642f126f). Confirms clean anaerobic *washed* sits clarity-side (like the Ilde Burbano Pink Bourbon), NOT Suppression. But single-mode Clarity-First percolation (Kalita) could not serve the coffee's **simultaneous under-extracted front + over-extracted back**; resolved on **Hybrid (Intensity-Clarity Split) on the Hario Switch** - hot closed immersion (95°C) reaches the underdeveloped attack, cooler (90°C) open drain cleanses the over-extracted back. Front-reach lever = Phase-1 closed-immersion steep time (1:50 under / 2:10 over + attack-body disintegration / 2:00 integrated), NOT grind. Peaks cool (≤50°C); transforms lemon-lime → peach/stone-fruit tea. Extends the under-front/over-back → Hybrid trigger (Pattern #2 refinement, Component Terra Pink Bourbon) beyond anaerobic *naturals* onto an anaerobic *washed* Bourbon. Water: MgCl₂+MgSO₄ blend @ GH44 (see water.md § 6).

- **Laurina / Bourbon Pointu (Bourbon family, Bourbon mutation lineage; natural) - n=1, 2026-07-28.** Picolot #14 "Barbie Beans" - Santa Felisa, Acatenango, Guatemala (Anabella Meneses), clean Natural, roasted light on the S7X (brew 63aad474-3918-40a2-8bc4-023e3ce6cafb). Low-density, low-caffeine, notoriously hard to roast - carried a **roast-derived burnt** note on aroma + attack that **faded as the cup cooled** even from a light-roasting roaster. The fade-cool behavior is the discriminator (roast-derived, not extraction-derived), and the lever is **lower brew temp (93->90C), NOT coarser grind / less contact**. Once the burnt cleared at 90C, an office-tap-amplified 'brown tea' body surfaced and muted the fruit; **coarsening EG-1 6.6->6.8 lifted the apple-pie sweetness above the body** (Kalita Wave 155 + xBloom Premium, 15g:250g 1:16.7, 90C). Confirmed **Clarity-First** - transparency-driven, sugar-forward, gentle acidity; landed the roaster's 'pink lady apple / cinnamon pie' intent as a layered apple-pie -> caramel -> cinnamon -> orange-cinnamon (cool) arc. This was a deliberate lower-extraction start against Picolot's Balanced->Full house style; a Full-Expression version of this lot remains untested and is the natural next experiment. 2 drops APAX Jamm added post-brew as the office sweetness lever (see Pattern #6).
