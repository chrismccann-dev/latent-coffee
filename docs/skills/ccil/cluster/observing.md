...
- **Promotion trigger:** 2-3 more medium-roast specialty naturals confirm the over-extraction-risk-is-roast-character lever holds. Chris flagged at the Item 15 grill that he has a couple of inventory lots with darker-than-normal readings expected to land in brewing rotation, so this candidate is likely to advance soon. Promote from operational-guide observation to a brewing-historian CCIL entry once threshold met.
