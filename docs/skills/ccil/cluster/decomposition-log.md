...
- **Dispatch-accuracy degradation** — recommendations consumed by planners (Roasting Assistant / Brewing Assistant / Learning Assistant) drift below the per-sub-skill autonomy graduation threshold from [ADR-0013](../../../adr/0013-self-improvement-primitives.md), measured as override rate across the last 12 dispatched recommendations.
