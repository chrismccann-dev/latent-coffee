# WBC Per-Strategy Patterns — Extraction Push

**Status:** PLACEHOLDER (Wave 2, 2026-05-26) — populate with WBC competitor recipes within Latent's Extraction Push strategy as patterns crystallize.
...
- Strong subset of competitive Gesha brews land here. Authoring opportunity: identify the WBC recipes that pivoted from Clarity-First to Extraction Push as the operator iterated on the same coffee.
- Document the Melodrip / Sibarist FAST anchor combinations across WBC recipes (cross-link with brewer + filter cluster).
