# WBC Per-Strategy Patterns — Hybrid

**Status:** PLACEHOLDER (Wave 2, 2026-05-26) — populate with WBC competitor recipes within Latent's Hybrid strategy as patterns crystallize.
...
- Document which Hybrid sub-form each Ferket / Carlos Escobar 2025 / etc. recipe maps to in Latent's framing.
- Identify the boundary between Selective Bloom sub-form (role assignment) and Output Selection modifier (fraction discarding) — Chris flagged this as a near-merge candidate during 2026-05-15 grilling.
