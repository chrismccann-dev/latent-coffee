...
| ✅ | docs/skills/brewing-equipment-expert/  [EquipmentReference] | 111.3 KB | 150 KB | claude.ai workflow |
| ✅ | docs/skills/brewing-historian/  [Historian] | 143.6 KB | 250 KB | claude.ai workflow |
...
2. **docs/skills/brewing-historian/cluster/patterns/cross-coffee-insights.md (80.0 / 80 KB)** — 🔴 at the Historian single-doc cap; watch / split next time it's touched.
3. **docs/prompts/one-shot.md (33.9 / 40 KB)** · **docs/skills/brewing-assistant/cluster/operational-guide.md (49.8 / 60)** · **wbc-recipes.md (48.8 / 60)** — ⚠️ approaching; watch.
