...
- **`concentration` modifier ship + Concentrated Pour-Over archival (spec'd 2026-08-31, ready to fire).** Kickoff brief: [docs/features/concentrated-pourover-modifier-kickoff-2026-08-31.md](docs/features/concentrated-pourover-modifier-kickoff-2026-08-31.md). Ships the sixth canonical modifier type (`lib/extraction-modifiers.ts` + push_brew/patch_brew schema), the AeroPress immersion-press method card (brewing-assistant cluster), and verifies end-to-end by push_brew'ing the three reproduced RP8 winners (Motta 1:10 Kalita / Loud Giants 1:10 valve / Project One Peach 1:10 press). Canon locked at the 2026-08-31 item-56 grill (CONTEXT-brewing headword). Planned-execution work (autonomy rule applies). **Trigger:** Chris's go.
