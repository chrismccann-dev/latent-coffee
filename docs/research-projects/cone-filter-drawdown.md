...
- Count-out-loud pour discipline ("50/100/150/200/250" at 6-second intervals) gave real-time feedback and corrected mid-pour without losing rhythm. Future research-project templates should make count-out-loud an explicit operational technique line in Per-Pull Procedure, not implicit.
