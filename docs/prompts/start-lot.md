...
- `read_doc(uri="docs://skills/wbc-roasting-archivist/cluster/sourcing/strategy.md")` — sourcing buckets (action axis) + 5-lane portfolio frame + sourcing channels + current Latent inventory mapped to lanes. The sourcing bucket shapes how much experiment investment is justified on this lot.
