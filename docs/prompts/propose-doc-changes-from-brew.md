# propose-doc-changes-from-brew.md (deprecated — redirect stub)
...
**Use instead:** [docs/prompts/bundled-brewing-completion.md](bundled-brewing-completion.md) — STEP 2 is the propose_doc_changes flow with auto-split when citations span multiple target_docs (Sub-sprint 2 Item 15(b)).
