...
- Preserve the Latent taste-apex vocabulary verbatim when the synthesis names it: layered-evolving (the canonical apex term — multidimensional and in motion across the temperature + structural arcs), its antonym one-dimensional, and the cross-lever keystone reveal-not-inject (the principle "reveal the latent, don't inject the absent") — do not paraphrase these into "complex", "expressive", "loud", "flat", or looser phrasings of the reveal-vs-inject distinction.
