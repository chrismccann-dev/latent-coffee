...
const DOC_CATALOG: CatalogDoc[] = [
  ...
  {
    uri: 'docs://skills/brewing-equipment-expert/cluster/water.md',
    title: 'Brewing Equipment Expert — Water cluster',
    description: 'Use when recording, describing, or building brewing water — the RP6 water-chemistry knowledge substrate (codification Phase A, 2026-07-04). Carries the recording schema (base / TDS / GH / KH / cation split / anion split / buffer source), the resolved mineral→role mechanism (the anion sets a phase, the cation gates it: SULFATE → body/sweetness, cation-agnostic; CHLORIDE → attack/acidity/florality but cation-GATED — Mg+Cl bright, Ca+Cl lactic), the decision chart (desired direction → salt/level, incl. WBC-seeded silica/potassium hypothesis rows not yet Latent-tested), the single-salt-stock build method (10k-ppm stocks, precipitation discipline, WATER-vs-CONCENTRATE labeling, measure-don\'t-guess), guardrails (less-is-more / post-brew is a bounded proxy / precipitation unbalances a cloudy concentrate), and a per-coffee recipe-library SEED (Pink Bourbon → MgCl₂-forward). Reference/soft enforcement — the FRAMEWORK is validated (Track 2 Lane B, all 5 HTs), but the specific directional VALUES + the recipe seed are single-coffee-PROVISIONAL (Pink-Bourbon-only, pending a 2nd-coffee replication). Water is wired into /brew (Phase B, 2026-07-04): at home, Step 2 offers a water.md-derived per-brew recipe; office records tap as-is. Physical stock lives in the sibling water-inventory.md.',
  },
  {
    uri: 'docs://skills/brewing-equipment-expert/cluster/water-inventory.md',
    title: 'Brewing Equipment Expert — Water inventory',
    description: 'Use when checking what water gear / reagents / concentrates Chris actually owns before building or suggesting a water recipe — the maintained physical inventory that keeps water.md (the knowledge) in sync with the shelf. Lists: base water (Mini Classic distiller), the raw single-mineral reagent kit (MgSO₄·7H₂O / MgCl₂·6H₂O / CaSO₄·2H₂O gypsum / CaCl₂·2H₂O / NaHCO₃ / KHCO₃, plus KCl + Morton NaCl + Eidon silica for the WBC-seeded future tracks), the commercial concentrates (Third Wave Water / DAK Hydro Drops / APAX Tonik-Jamm-Lylac / KONFLUX / NÉMO / SBL Juicy&Sweet / Sooper), and the measurement + prep gear (A&D EJ-123 0.001g balance, Apera EC60 + 84/1413 standards + Hanna 1413, LaMotte BrewLab, API GH/KH, two 4E micropipettes, INTLLAB stirrer, dropper bottles). Living doc — update on acquisition/depletion. Seeded 2026-07-04 at RP6 codification close.',
  },
  ...
  {
    uri: 'docs://skills/brewing-assistant/cluster/aeropress-immersion-press.md',
    title: 'Brewing Assistant — AeroPress immersion-press method card (Concentrated Pour-Over, press form)',
    description: 'Use when brewing the Concentrated Pour-Over style in its immersion-press form — the AeroPress Premium inverted method card (RP8 Track 5 amended lock, 2026-08-31): 1:10 · EG-1 7.0 · 89°C · 2 saturation stirs · steep to 1:00 · flip ~10 s · slow press ≈50-55 s to first sustained hiss · ~2:00-2:05 TOTAL. Covers the two co-equal serving forms (1:10 undiluted; 1:9 + ~20% bypass-to-optimum) and the "no dilution past optimum" identity rule, plus mechanism notes (boundary is mechanism-dependent, astringency-free form, press-to-hiss yield slack). Archive these brews with the `concentration` modifier, scope "immersion-press form".',
  },
  // ----- skills / brewing-equipment-expert -------------------------------------
  {
