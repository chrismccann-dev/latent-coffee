...
const SKILL_FILES: Record<string, string> = {
  ...
  'docs://skills/roasting-historian/cluster/learnings/rwa-nova-nat21-rb-2026.md': 'docs/skills/roasting-historian/cluster/learnings/rwa-nova-nat21-rb-2026.md',
