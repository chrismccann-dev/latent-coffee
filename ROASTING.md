...
- V1 batches 128/130/131 - structural issues (Maillard 48-52%, drop temps 209-211°C). #130 produced cup close to Special Guests (London) reference roast
- Confirmed flavor target: lemongrass, ginger, brown sugar, bergamot - identified via direct reference roast comparison
- WB-to-ground deltas in V1 very large (7-11 points) - fruit layer insulating core significantly
- V2 hypothesis: keep 247°C peak, steepen ramp in 1:00-2:00 window, strict drop at 206-207°C, new BBP/hopper pre-load protocol applied
...
| **Natural with visible fruit layer** | May need more energy than density/moisture predict (fruit layer thermal insulation). Do NOT assume "natural = less heat." Start from washed profile energy, let FC timing correct down only if it arrives early and hot. | Medium - confirmed on Sudan Rume Natural V1 (required 247°C peak, not lower) |
...
| Sudan Rume Natural | Lemongrass, ginger, brown sugar, bergamot, blueberry | Flat, thin, missing lemongrass attack | Dark tea, ginger suppressed, body-heavy, muted | CGLE-SRUME-NATURAL-2026 + Special Guests direct tasting |
