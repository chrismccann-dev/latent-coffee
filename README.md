...
- [BREWING.md](BREWING.md) — Brewing master reference: 6 strategies + 4 modifiers, Two-Axis Framework, equipment reference. Cross-Coffee Insight Layer migrated to the [Brewing Historian](docs/skills/brewing-historian/) cluster in Wave 2 PR 2 (2026-05-26); BREWING.md keeps the h1 pointer block for back-compat.
...
- [docs/brewing/](docs/brewing/) — Roaster reference cards, WBC reference (5-axis foundational map + 9 strategy families), 154-recipe WBC corpus (2022-2026)
- [docs/roasting/archive.md](docs/roasting/archive.md) — Closed-lot archive (per-lot Key Learnings)
- [docs/prompts/](docs/prompts/) — 10 operational prompts. Brewing-side is now Claude-Code substrate (claude.ai brewing retired 2026-06-18; brew sessions run the `/brew` skill): start-brew (mobile fallback entry) / bundled-brewing-completion (completion engine). Roasting-side runs in claude.ai, two families: V-set lots use start-lot / log-roast / log-cupping / close-lot (4 prompts, 1:1 against the 4-state lifecycle, 2026-05-14 rewrite); one-shot lots (green_beans.is_one_shot=true, single-batch samples) use one-shot / one-shot-closeout (2 prompts, 2026-05-15 sprint).
