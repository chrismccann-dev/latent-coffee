...
- **MCP Tool-count discoverability** — 39 Tools today; claude.ai's `tool_search` ranks opaquely. At 50+, consider consolidation (polymorphic `push_*`) or namespace grouping. Description-quality lever already pulled (PR #114).
