...
- **Chris's default next task:** candidate #1 sub-sprint 1c (Variety Observed corpus distillation, deferred) — per-cultivar Observed subsections for Gesha / 74158 / Sidra. Chris-driven authoring. Separately, hand the Terroir CSV over to Claude to kick off 1d.1.
