...
**Last reorder:** 2026-04-24 (**sub-sprint 1i shipped**; 1h Roaster promoted to top Claude priority). **Sequencing:** ~~1i SR canonical rebuild~~ ✅ → **1h Roaster adoption** → 1m Roast level → 1k Grinder → 1l Producer → 1f Brewer+filter → 1g Flavor (Chris-parallel) → 2.1 V1-brews dog-food → 2.2-2.6 V2 brainstorm + build.
