...
- **Region content backfill (Reference Taxonomies sub-sprint 1d.2, migration 024)** — mirror of Variety 1a.2. 22 UPDATEs populating 11 attribute content columns (context / elevation / climate / soil / farming_model / dominant_varieties / typical_processing / cup_profile / acidity_character / body_character / why_it_stands_out) on every existing `terroirs` row from `docs/taxonomies/regions.md`. `climate_stress` stays free-text (not a canonical list); `typical_processing` uses Title Case. Supersedes migration 009 (the partial backfill from the terroir macro redesign). Zero schema / code / FK change. Terroir detail pages now render the macro-level reference content immediately without waiting for 1d.3's enforcement.
...
**Sub-sprint 1d.2 — Region content backfill (✅ shipped 2026-04-22).** Mirror of Variety 1a.2. Migration 024 — 22 UPDATEs populating 11 attribute content columns (context / elevation / climate / soil / farming_model / dominant_varieties / typical_processing / cup_profile / acidity_character / body_character / why_it_stands_out) on every existing `terroirs` row from `docs/taxonomies/regions.md`. `climate_stress` stays free-text; `typical_processing` uses Title Case. Supersedes migration 009. Zero schema / code / FK change.
...
| 2026-04-22 | Region content backfill (Reference Taxonomies sub-sprint 1d.2) | Migration 024 — 22 UPDATEs populating 11 attribute content columns on every existing `terroirs` row from `regions.md`. Supersedes migration 009. Zero schema / code / FK change. |
