...
**Wave 3 PR 1 shipped 2026-05-26** — Peer-Learning Roasting Archivist + Roest Knowledge operator-stub Knowledge clusters (3 + 10 cluster files; ~31KB ROASTING.md shrink). Remaining Wave 3 work: 9 workflow tier sub-skills (4 planning + 5 executing). **POD-1 lands inside Cupping Specialist** — Path A/B/C routing + simulated-pourover-as-3rd-cup-read + cross-project handoff lifecycle states. Several constituent sub-skills can ship in parallel. **Cleanup pass deferred** — Naturals - Roasting Framework + Honey Process - Roast Direction Fork stayed in ROASTING.md per Chris-lock during PR 1; both flagged as needing a future cleanup-pass reclassification (Roasting Historian by-process/ vs stay-in-master). Run as final Wave 3 sprint after the 9 workflow sub-skills land OR fold into Wave 4 redirect-stub work.

**Triggers when:** Wave 2 closes (closed 2026-05-26). **PR 1 shipped 2026-05-26.**
